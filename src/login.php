            ...
            if (empty($_POST['email'])) {
                ...
                for ($i = 0; $i < count($users); $i++) {
                    if ($_POST['email'] == $users[$i]['mail']) {
                        ...
                        break;
                    } elseif ($_POST['email'] != $users[$i]['mail']) {
            ...
            if (empty($_POST['mdp'])) {
                ...
                for ($i = 0; $i < count($users); $i++) {
                    if ($_POST['mdp'] == $users[$i]['password']) {
                        ...
                        $_SESSION['mdp'] = $mdp;
                        break;
                    } elseif ($_POST['mdp'] != $users[$i]['password']) {
    ...
    <form action="" method="POST">
        <div class="d-flex justify-content-center">
            <div>
                ...
                <div class="text-center">
                    <input class="mt-1 taille-email design-email" id="email" type="text" name="email" placeholder="email" value="<?= $_POST[
                    'email'
                ] ?? '' ?>">
                </div>
            </div>
        ...
        <div class="d-flex justify-content-center">
            <div>
                ...
                <div class="text-center">
                    <input class="mt-1 taille-mdp design-mdp" id="mdp" type="password" name="mdp" placeholder="mot de passe" value="<?= $_POST[
                    'mdp'
                ] ?? '' ?>">
                </div>
            </div>
